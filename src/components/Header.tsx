        ...
        <div className="flex items-center justify-between h-11 gap-3">
          <div className="flex items-center gap-1.5 flex-shrink-0">
            <div
              ...
              style={{ background: 'linear-gradient(135deg, var(--t-accent-500), var(--t-accent-700))' }}
            >
            ...
            <span className="text-sm font-bold leading-none" style={{ color: 'var(--t-text-main)' }}>统一门户</span>
          </div>
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            <div className="relative hidden sm:block">
              <div className="absolute inset-y-0 left-0 pl-2 flex items-center pointer-events-none" style={{ color: 'var(--t-text-mute)' }}>
              ...
              <input
                ...
                className="w-44 lg:w-56 pl-7 pr-2 py-1 text-[11px] border rounded focus:outline-none focus:ring-2 transition-all"
                style={{
            ...
            <div className="relative">
              <button
                ...
                className="w-6.5 h-6.5 rounded border flex items-center justify-center transition-colors hover:opacity-90"
                style={{
              ...
              {showAccents && (
                <>
                  <div className="fixed inset-0 z-40" onClick={() => setShowAccents(false)} />
                  <div
            ...
            <button
              ...
              className="w-6.5 h-6.5 rounded border flex items-center justify-center transition-colors"
              style={{
                width: '26px', height: '26px',
            ...
            <div className="flex items-center gap-1 pl-1 border-l" style={{ borderColor: 'var(--t-border-sub)' }}>
              <div
                className="rounded-full flex items-center justify-center text-white text-[10px] font-semibold shadow-sm"
                style={{
                  width: '26px', height: '26px',
